...
package com.github.shannah.oaitest54;
 ...
 * @author Shai Almog
 */
public class OaiTest54Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Oai Test 54";
    private static final String APP_NAME = "oai-test-54";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new OaiTest54Stub());
    }
